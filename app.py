...
def result():
    ...
    scaler_path=os.path.join('D:/ML Projects/Stroke-Risk-Prediction-using-Machine-Learning-master','models/scaler.pkl')
    scaler=None
    ...
    model_path=os.path.join('D:/ML Projects/Stroke-Risk-Prediction-using-Machine-Learning-master','models/dt.sav')
